...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 overflow-x-hidden">
      ...
      {/* Team Section - Elegant and Minimalistic */}
      <section id="team" className="py-16 bg-gradient-to-b from-white via-cream/10 to-white relative overflow-hidden">
        {/* Subtle background elements */}
        <div className="absolute top-0 left-0 w-full h-full opacity-5">
          <div className="absolute top-20 left-20 w-40 h-40 bg-gradient-to-br from-bronze/20 to-transparent rounded-full blur-2xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-charcoal/60 mt-8 font-light tracking-wide">
              Meet the talented people who bring your vision to life
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-20 max-w-5xl mx-auto">
            {[
              ...
              >
                <div className="relative bg-white shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden">
                  {/* Member image */}
                  <div className="relative h-80 sm:h-96 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                      <div className="flex items-center justify-center space-x-3">
                        <a href={member.linkedin} className="w-10 h-10 bg-white/95 flex items-center justify-center hover:bg-bronze hover:text-white transition-all duration-300 shadow-lg">
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                          </svg>
                        </a>
                        <a href={member.instagram} className="w-10 h-10 bg-white/95 flex items-center justify-center hover:bg-bronze hover:text-white transition-all duration-300 shadow-lg">
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="p-8">
                    <div className="text-center mb-4">
                      <h3 className="font-italiana text-2xl text-charcoal mb-2 group-hover:text-bronze transition-colors duration-300">
                        {member.name}
                      </h3>
                    ...
                    <p className="text-charcoal/70 text-sm leading-relaxed font-light text-center group-hover:text-charcoal transition-colors duration-300">
                      {member.bio}
                    </p>
                  </div>
                </div>
